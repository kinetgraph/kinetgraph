...
| [ADR-052](ADRs/ADR-052-PyPI-Publishing.md) | PyPI publishing via Trusted Publishing (PEP 740) | Proposed (workflow split: `release.yml` cuts the tag, `publish.yml` builds + uploads; 15 contract tests enforce the split) |
